...
| R2 | 2026-09-20/21 | **chiusa con riserve** | `reports/R2.html` | 30 ROI 1 mm² (5/archetipo), 3 segmentatori (Cellpose-SAM RGB, StarDist HE, Space Ranger 4), scale 1/2/4. Check C 4 PASS + 3 WARN; check B: 4 attese numeriche su 6 **smentite** (A4 ≈ 24 500/mm², area linfociti 14 µm², A5 ≈ 1 300/mm², A3 > A5); controprova: i segmentatori disaccordano 12–55 % (direzione tessuto-dipendente) → BIO_REFERENCES v1 (B-001…B-042) **provvisoria** fino a conteggio manuale (BL-024). Revisione avversariale 15/3/1 (discrepanze accolte); chiusura `d4c8a9e` |
